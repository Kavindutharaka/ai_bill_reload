...
records = query(f"SELECT id, name, phone, bill_number, bill_date, shop_name, bill_total, eligible_total, is_eligible, items_json, capture_mode, reload_sent, created_at FROM rek_cc_reg WHERE DATEADD(MINUTE, 330, created_at) >= '{REPORT_DATE} 00:00:00' AND DATEADD(MINUTE, 330, created_at) < '2026-03-30 00:00:00' ORDER BY created_at DESC")
